...
Abstract:
    ...
    This is the main module of the MBKS_5 miniFilter driver.
...
VOID
MBKS5InstanceTeardownStart (
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _In_ FLT_INSTANCE_TEARDOWN_FLAGS Flags
    );

VOID
MBKS5InstanceTeardownComplete (
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _In_ FLT_INSTANCE_TEARDOWN_FLAGS Flags
    );
...
#pragma alloc_text(PAGE, MBKS5Unload)
#pragma alloc_text(PAGE, MBKS5InstanceQueryTeardown)
#pragma alloc_text(PAGE, MBKS5InstanceSetup)
#pragma alloc_text(PAGE, MBKS5InstanceTeardownStart)
#pragma alloc_text(PAGE, MBKS5InstanceTeardownComplete)
#endif
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("MBKS5!MBKS5InstanceSetup: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("MBKS5!MBKS5InstanceQueryTeardown: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("MBKS5!MBKS5InstanceTeardownStart: Entered\n") );
}
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("MBKS5!MBKS5InstanceTeardownComplete: Entered\n") );
}
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("MBKS5!MBKS5OperationStatusCallback: Entered\n") );

    PT_DBG_PRINT( PTDBG_TRACE_OPERATION_STATUS,
                  ("MBKS5!MBKS5OperationStatusCallback: Status=%08x ctx=%p IrpMj=%02x.%02x \"%s\"\n",
                   OperationStatus,
                   RequesterContext,
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("MBKS5!MBKS5PostOperation: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("MBKS5!MBKS5PreOperationNoPostOperation: Entered\n") );
